...
from ..tools.access_context import extract_user_context
...
async def query_database(request: QueryRequest):
    ...
    try:
        ...
        auth_data = await chatbot_auth_client.authenticate_user(request.phone_no)
        user_context = extract_user_context(auth_data)
        
        allowed_rep_codes = user_context["allowed_rep_codes"]
        user_role = user_context["user_type"]
